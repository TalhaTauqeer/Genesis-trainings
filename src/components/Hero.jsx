    ...
    <div className="relative">
      ...
      <div className="relative h-[90vh] w-full overflow-hidden">
        ...
        <div className="relative z-20 flex h-full items-center justify-center px-4 text-center text-white sm:px-6 lg:px-8">
          <div>
            <h1 className="mx-auto max-w-4xl text-4xl font-bold sm:text-6xl md:text-5xl">
              Empowering the Next Generation of Innovators
            </h1>
            <p className="mx-auto mt-4 max-w-2xl text-lg sm:text-xl md:text-xl">
              Genesis Trainings deliver expert-led programs to thrive in today
              {"'"}s digital economy.
            </p>
          </div>
        </div>
      ...
      <Container className="pt-20 pb-16 text-center lg:pt-20">
        <h2 className="mb-20 text-4xl font-bold text-[#004875] text-lg sm:text-2xl md:text-3xl">
          Leading the Nation through IT Trainings & Innovation
        </h2>
      ...
      <section className="mx-auto mt-16 mb-24 max-w-[90vw] px-4 md:px-6 text-center md:max-w-6xl">
        <div className="grid grid-cols-1 gap-8 text-[#004875] justify-start items-start md:grid-cols-3">
          {/* Our Vision */}
          <div className="px-6 md:px-12">
            <h2 className="mb-4 text-2xl sm:text-3xl font-bold tracking-wide md:text-4xl">
              OUR     VISION
            </h2>
            <img
          ...
          {/* Our Mission */}
          <div className="px-6 md:px-12 md:border-r-2 md:border-l-2 md:border-[#004875]">
            <h2 className="mb-4 text-2xl sm:text-3xl font-bold tracking-wide md:text-4xl">
              OUR MISSION
            </h2>
            <img
