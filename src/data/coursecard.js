export const courses = [
  {
    ...
    details: {
      ...
      highlights: [
        ...
        "Access to Exclusive Design Community",
        "Earn Genesis Certificate upon assessment",
        "Build a real design portfolio",
        "Hands-on projects using industry tools",
        "Career-ready, freelancing-focused content",
      ],
      content: [
        ...
        "Creative Thinking & Design Process",
      ...
      whyJoin: [
        ...
        "Get 1-year trainer support after course completion.",
      ],
      coreSkills: [
      ...
      moduleSnapshot: [
        ...
        },
        {
          ...
          points: [
            "Banners",
            "Posts",
            "Ads for Instagram, Facebook, LinkedIn, etc.",
          ],
        },
        {
      ...
      careerOutlook:
        "Become a Freelance Graphic Designer, Work for Design Agencies, or Start Your Own Design Studio.",
      certification: [
        {
          recommendation: [
            "[Coursera – Fundamentals of Graphic Design by CalArts (University of California)]",
            "Free enrollment option available",
            "Certificate upon completion",
            "Offered by an internationally recognized university",
          ],
          link: "Link: https://www.coursera.org/learn/graphic-design",
        },
      ],
    },
  },
  {
    ...
    details: {
      ...
      content: [
        ...
        "Logistics and COD",
        "Customer support and store management",
        "Ad creation and optimization",
        "Freelancing with Shopify skills",
      ],
      whyJoin: [
        "Launch your store with hands-on guidance",
        "Master Shopify and eCommerce essentials",
      ...
      coreSkills: [
        ...
        "COD setup and local/global sales",
      ],
      tools: [
        "Shopify",
        "Facebook Ads",
      ...
      careerOutlook:
        "Become a Shopify Seller, eCommerce Specialist, or Online Store Consultant.",
    },
  },
  {
    index: 3,
    ...
    details: {
      ...
      highlights: [
        ...
        "Get 1-Year Trainer Support",
        "Access to Upgraded Private Community",
        "Genesis Certificate upon assessment",
      ],
      content: [
        "SEO, SEM, and AI tools",
      ...
      whyJoin: [
        "Learn from real marketing pros",
        "Use AI tools to grow brands",
        "Build career-ready skills for the digital age",
      ],
      coreSkills: [
        "SEO & SEM",
      ...
      careerOutlook:
        "Work as Digital Marketer, SEO Specialist, Social Media Manager, or Start Your Own Agency",
    },
  },
  {
    index: 4,
    ...
    details: {
      ...
      whyJoin: [
        "Learn from experienced AI/ML developers",
        "Hands-on project-based curriculum",
        "Build freelance-ready portfolio",
      ],
      coreSkills: [
        "AI & ML Fundamentals",
        "Python Programming",
